...
$query = sprintf("SELECT id, nome, descricao, video FROM jogos");
    ...
    <div class="container-fluid">
                                        ...
                                        <div class="row justify-content-center mb-5">
                                            <div class="col-sm-6 ml-3">
                                                <div class="embed-responsive embed-responsive-16by9">
                                                    <iframe class="embed-responsive-item" src="<?=$linha['video']?>"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center my-5 mb-5">
                <div class="col-sm-1">
                    <a href="cadastrar_jogo.php" id="botao" class="btn"><p>Cadastrar Jogo</p></a>
                </div>
            </div>
        </div>
